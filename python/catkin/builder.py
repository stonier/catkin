...
try:
    ...
    sys.exit(
        'Failed to import catkin_pkg module:\n  ' +
        str(e) + '\n' +
        'Make sure that you have installed "catkin_pkg", it is '
        'up-to-date and on the PYTHONPATH.'
    )
    ...
    for path, package in packages:
        ...
        if 'metapackage' in export_tags:
            ...
            if build_type_tag == 'catkin':
                ...
                unknown_built_types.append(package)
    msg.append('@{pf}~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
